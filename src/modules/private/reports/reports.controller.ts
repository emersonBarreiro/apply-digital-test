...
export class ReportsController {
  ...
  @ApiOperation({ summary: 'Get percentage of deleted vs non-deleted products' })
  @ApiResponse({ status: 200, description: 'Deletion report retrieved successfully' })
  ...
  @ApiOperation({ summary: 'Get percentage of products with/without price in date range' })
  ...
  @Get('data-quality')
  @ApiOperation({ summary: 'Get data quality report with missing fields and invalid data' })
  @ApiResponse({ status: 200, description: 'Data quality report retrieved successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
